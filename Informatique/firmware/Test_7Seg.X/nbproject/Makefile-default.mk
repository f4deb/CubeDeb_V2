...
SOURCEFILES_QUOTED_IF_SPACED=../src/common/7seg/7segments.c ../src/common/7seg/7segmentsOutputStream.c ../src/common/delay/delay.c ../src/common/error/error.c ../src/common/IO/buffer/buffer.c ../src/common/IO/outputStream/outputStream.c ../src/common/IO/printWriter/printWriter.c ../src/common/led/led.c ../src/common/system/system.c ../src/common/timer1/timer1.c ../src/common/uart5/uart5.c ../src/config/default/peripheral/cache/plib_cache.c ../src/config/default/peripheral/cache/plib_cache_pic32mz.S ../src/config/default/peripheral/clk/plib_clk.c ../src/config/default/peripheral/coretimer/plib_coretimer.c ../src/config/default/peripheral/evic/plib_evic.c ../src/config/default/peripheral/gpio/plib_gpio.c ../src/config/default/peripheral/i2c/master/plib_i2c1_master.c ../src/config/default/peripheral/tmr/plib_tmr2.c ../src/config/default/peripheral/tmr1/plib_tmr1.c ../src/config/default/peripheral/uart/plib_uart2.c ../src/config/default/peripheral/uart/plib_uart5.c ../src/config/default/stdio/xc32_monitor.c ../src/config/default/initialization.c ../src/config/default/interrupts.c ../src/config/default/exceptions.c ../src/cube/cubeCommon7Seg.c ../src/cube/mainCubeMeteo.c ../src/drivers/segSAA1064T/segSAA1064T.c ../src/drivers/SAA1064T/SAA1064T.c ../src/mainCube.c
...
${OBJECTDIR}/_ext/94714981/segSAA1064T.o: ../src/drivers/segSAA1064T/segSAA1064T.c  .generated_files/a01017d000456c934aeb04283e8cfde16f7cd981.flag .generated_files/f1ca444b8d15f85172eef40e82dcd04fec010b72.flag
...
${OBJECTDIR}/_ext/94714981/segSAA1064T.o: ../src/drivers/segSAA1064T/segSAA1064T.c  .generated_files/f726c876941ad39c78279a90d80be1a09d5b0db1.flag .generated_files/f1ca444b8d15f85172eef40e82dcd04fec010b72.flag
	@${MKDIR} "${OBJECTDIR}/_ext/94714981" 
	@${RM} ${OBJECTDIR}/_ext/94714981/segSAA1064T.o.d 
	@${RM} ${OBJECTDIR}/_ext/94714981/segSAA1064T.o 
	${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -ffunction-sections -O1 -I"../src" -I"../src/config/default" -I"../src/packs/PIC32MZ2048EFM100_DFP" -Wall -MP -MMD -MF "${OBJECTDIR}/_ext/94714981/segSAA1064T.o.d" -o ${OBJECTDIR}/_ext/94714981/segSAA1064T.o ../src/drivers/segSAA1064T/segSAA1064T.c    -DXPRJ_default=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -mdfp="${DFP_DIR}"  
